        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="flex flex-col items-center text-primary lg:space-y-12">
            <div className="text-center">
              ...
              <p className="text-lg text-green-950 max-w-xs text-center lg:max-w-md mx-auto lg:text-xl  lg:my-16">
                {description}
              </p>
            </div>
            <Image
            ...
            <Button onClick={onClick} variant={"round-outline"} className="px-7 py-6 text-lg font-semibold">
              {buttonText}
            </Button>
          </div>
        </div>
